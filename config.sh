...
set_permissions() {
  ...
  set_perm_recursive  $MODPATH/system/customize/MSN       0       0       0755            0644
  set_perm_recursive  $MODPATH/system/customize/ACC       0       0       0755            0644
  set_perm  $MODPATH/system/customize/msn_map.xml       0       0       0644
